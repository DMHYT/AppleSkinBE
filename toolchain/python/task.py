...
def task_load_docs():
	...
	print("downloading...")
	files = ["core-engine", "android-declarations", "android"]
	for f in files:
		response = urlopen("https://docs.mineprogramming.org/" + f + ".d.ts")
		content = response.read().decode('utf-8')
		with open(make_config.get_path("toolchain/declarations/" + f + ".d.ts"), 'w') as decl:
			decl.write(content)
	print("complete!")
	return 0
